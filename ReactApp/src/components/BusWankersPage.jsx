    ...
    <div className="bus-wankers-page">
      <div className="container">
        ...
        <div className="image-container">
          <img src="Hippies_1.png" alt="ImportExport Image" className="image-with-shadow" />
        </div>
        
        <h4>In AutoFill Options you will see a band of tabs across the top. You should be on the Sync tab to start.</h4>
        
        <div className="image-container">
          <img src="sync.png" alt="sync Image" className="image-with-shadow" />
        </div>
        ...
        <h4>
          You can click 
          <a href="g_autofill.csv" download="g_autofill.csv">this link</a> 
        ...
        <div className="image-container">
          <img src="formfield.png" alt="Form Fields Image" className="image-with-shadow" />
        </div>
        ...
        <h4>
          ...
          <a href="test_page.html"> clicking here</a>.
        </h4>
        ...
        <div className="video-container">
          <video controls width="640" height="360">
            <source src="DannyVid.mp4" type="video/mp4" />
